...
enum Role { ROLE_ADMIN = 1, ROLE_MEMBER = 2 };
...
public:
    Admin(const string& id, const string& name) : User(id, name, ROLE_ADMIN) {}
...
public:
    Member(const string& id, const string& name) : User(id, name, ROLE_MEMBER) {}
